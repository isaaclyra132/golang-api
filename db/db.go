...
var Filmes = []models.Filme{
	...
	// {ID: "6", Titulo: "Coringa 2", Direcao: "Todd Phillips", Producao: "Village, Roadshow Pictures, DC Films, Sikelia Productions, Joint Effort Productions, Green Hat Films", AnoLancamento: 2023},
}
